                  ...
                  <div key={t.id} style={S.card}>
                    <div style={{ display: "flex", alignItems: "start", gap: 12, marginBottom: 12 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {upcoming && <p style={{ margin: "0 0 5px", fontSize: 12, color: C.blue }}>🕐 {formatDatetime(upcoming)}</p>}
                    ...
                    <div key={i.id} style={S.card}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        {tournament?.whatsappLink && i.status === "aprobada" && (
                          <a href={tournament.whatsappLink} target="_blank" rel="noopener noreferrer" style={{ fontSize: 22, textDecoration: "none" }}>💬</a>
                        )}
                      </div>
                    </div>
                  );
